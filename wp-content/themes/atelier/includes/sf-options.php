			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'type' => 'button_set',
						'title' => __('Shop Slider - main shop page only', 'uplift'),
						'subtitle' => __('Enable this option to have the shop slider only show on the main shop page, and not categories.', 'uplift'),
						'desc' => '',
						'options' => array('1' => 'On','0' => 'Off'),
						'default' => '0'
						),
