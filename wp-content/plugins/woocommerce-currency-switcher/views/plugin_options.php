    ...
    <div class="section">
        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                ...
                <strong style="color: red;">In the free version of the plugin you can operate with 2 ANY currencies only. <a href="http://currency-switcher.com/a/buy" target="_blank">Premium version of the plugin</a></strong><br />
...
<?php endif; ?>
            ...
            <div id="tabs-5">
                <ul>
                    ...
                    <li>
                        <a href="http://www.woocommerce-filter.com/a/buy" target="_blank"><img src="<?php echo WOOCS_LINK ?>img/woof_banner.png" /></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 50%;">
                ...
                <a href="http://currency-switcher.com/a/buy" target="_blank"><img src="<?php echo WOOCS_LINK ?>img/woocs_banner.png" alt="<?php _e("full version of the plugin", 'woocommerce-currency-switcher'); ?>" /></a>
            </td>
            <td style="width: 50%;">
                <h3><?php _e("Get WooCommerce Products Filter", 'woocommerce-currency-switcher') ?>:</h3>
                <a href="http://www.woocommerce-filter.com/a/buy" target="_blank"><img src="<?php echo WOOCS_LINK ?>img/woof_banner.png" alt="<?php _e("WOOF", 'woocommerce-currency-switcher'); ?>" /></a>
            </td>
        </tr>
    </table>
