function embedSelectedShortcode() {
    ...
    if ( current_shortcode != -1 ) {
        ...
        var fwvideo_imageheight = document.getElementById( 'fwvideo-imageheight' ).value;
        var fwvideo_imagewidth = document.getElementById( 'fwvideo-imagewidth' ).value;
        ...
        if ( shortcode_select == 'shortcode-icons' ) {
            shortcodeHTML = '[sf_icon image="' + icon_image + '" character="' + icon_character + '" size="' + icon_size + '" cont="' + icon_cont + '" float="' + icon_float + '" color="' + icon_color + '"]';
        }
        ...
        if ( shortcode_select == 'shortcode-fwvideo' ) {
            ...
            shortcodeHTML = '[sf_fullscreenvideo type="' + fwvideo_type + '" btntext="' + fwvideo_btntext + '" imageurl="' + fwvideo_imageurl + '" imageheight="' + fwvideo_imageheight + '" imagewidth="' + fwvideo_imagewidth + '" videourl="' + fwvideo_videourl + '" extraclass="' + fwvideo_extraclass + '"]<br/>';
